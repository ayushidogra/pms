...
&emsp;&emsp;&emsp;&emsp;&emsp;
		...
		<a href="addPolicy.html" class="btn btn-dark form-rounded" >Add Policy</a>
<form>
                        </div>
                        ...
                        <tr>
                          ...
                          <td>
                            <center>
                             ...
                             <a href="editPolicy.html?id=${product.policyId}" class="btn btn-secondary form-rounded"  width="50px"> &emsp;Edit&emsp; 
                              </a>&emsp;&emsp;
